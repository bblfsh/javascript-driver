...
var (
	...
	PropertyCallee       = ann.HasInternalRole("callee")
	PropertyConsequent   = ann.HasInternalRole("consequent")
	PropertyDeclaration  = ann.HasInternalRole("declaration")
	PropertyDeclarations = ann.HasInternalRole("declarations")
	PropertyDecorators   = ann.HasInternalRole("decorators")
	PropertyDirectives   = ann.HasInternalRole("directives")
	PropertyDiscriminant = ann.HasInternalRole("discriminant")
	PropertyElements     = ann.HasInternalRole("elements")
	PropertyExported     = ann.HasInternalRole("exported")
	PropertyExpression   = ann.HasInternalRole("expression")
	PropertyExpressions  = ann.HasInternalRole("expressions")
	PropertyFinalizer    = ann.HasInternalRole("finalizer")
	PropertyHandler      = ann.HasInternalRole("handler")
	PropertyId           = ann.HasInternalRole("id")
	PropertyImported     = ann.HasInternalRole("imported")
	PropertyInit         = ann.HasInternalRole("init")
	PropertyKey          = ann.HasInternalRole("key")
	PropertyLabel        = ann.HasInternalRole("label")
	PropertyLeft         = ann.HasInternalRole("left")
	PropertyLocal        = ann.HasInternalRole("local")
	PropertyMeta         = ann.HasInternalRole("meta")
	PropertyObject       = ann.HasInternalRole("object")
	PropertyOperator     = ann.HasInternalRole("operator")
	PropertyParam        = ann.HasInternalRole("param")
	PropertyParams       = ann.HasInternalRole("params")
	PropertyProperty     = ann.HasInternalRole("property")
	PropertyProperties   = ann.HasInternalRole("properties")
	PropertyQuasi        = ann.HasInternalRole("quasi")
	PropertyQuasis       = ann.HasInternalRole("quasis")
	PropertyRight        = ann.HasInternalRole("right")
	PropertySource       = ann.HasInternalRole("source")
	PropertySpecifiers   = ann.HasInternalRole("specifiers")
	PropertySuperClass   = ann.HasInternalRole("superClass")
	PropertyTag          = ann.HasInternalRole("tag")
	PropertyTest         = ann.HasInternalRole("test")
	PropertyUpdate       = ann.HasInternalRole("update")
