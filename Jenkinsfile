pipeline {
  agent {
    kubernetes {
      label 'javascript-driver-bblfsh-performance'
      defaultContainer 'javascript-driver-bblfsh-performance'
      yaml """
spec:
  nodeSelector:
  ...
  containers:
  - name: javascript-driver-bblfsh-performance
...
"""
  ...
  environment {
    DRIVER_LANGUAGE = "javascript"
    DRIVER_REPO = "https://github.com/bblfsh/javascript-driver.git"
